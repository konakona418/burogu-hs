...
-}
renderSearch :: SiteConfig -> [(Text, Text)] -> [(Text, Text)] -> Text -> Text -> L.Html ()
renderSearch cfg navPages footerLinks cssRef title = H.layout cfg navPages footerLinks cssRef pageMeta $ do
